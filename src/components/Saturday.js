...
function Saturday({ disableAudioDays, setDisableAudioDays }) {
	const {
		selectedAudio,
		currentTime,
		activeInput,
	...
	useEffect(() => {
		const savedInputs = localStorage.getItem('saturdayInputs')
		if (savedInputs) {
			setSaturdayInputs(JSON.parse(savedInputs))
		}
	}, [])
	...
	useEffect(() => {
		localStorage.setItem('saturdayInputs', JSON.stringify(saturdayInputs))
	}, [saturdayInputs])
			...
			<center>
				<div className='card'>
					<p className='card__name'>
						...
						<h3 className='subtitle'>Суббота</h3>
					</p>
					<select
						style={{
							background: 'white',
							...
							<div className=''>
								<div className=''>
									<div className='grid'>
										<input
											type='time'
											defaultValue={saturdayInputs.input1}
											onFocus={() => handleInputFocus(0)}
											onChange={e => handleInputChange('input1', e)}
										/>
										<input
											type='time'
											defaultValue={saturdayInputs.input2}
									...
									<div className='grid'>
										<input
											type='time'
											defaultValue={saturdayInputs.input3}
											onFocus={() => handleInputFocus(2)}
											onChange={e => handleInputChange('input3', e)}
										/>
										<input
											type='time'
											defaultValue={saturdayInputs.input4}
									...
									<div className='grid'>
										<input
											type='time'
											defaultValue={saturdayInputs.input5}
											onFocus={() => handleInputFocus(4)}
											onChange={e => handleInputChange('input5', e)}
										/>
										<input
											type='time'
											defaultValue={saturdayInputs.input6}
								...
								<div className=''>
									<div className='grid'>
										<input
											type='time'
											defaultValue={saturdayInputs.input7}
											onFocus={() => handleInputFocus(6)}
											onChange={e => handleInputChange('input7', e)}
										/>
										<input
											type='time'
											defaultValue={saturdayInputs.input8}
									...
									<div className='grid'>
										<input
											type='time'
											defaultValue={saturdayInputs.input9}
											onFocus={() => handleInputFocus(8)}
											onChange={e => handleInputChange('input9', e)}
										/>
										<input
											type='time'
											defaultValue={saturdayInputs.input10}
									...
									<div className='grid'>
										<input
											type='time'
											defaultValue={saturdayInputs.input11}
											onFocus={() => handleInputFocus(10)}
											onChange={e => handleInputChange('input11', e)}
										/>
										<input
											type='time'
											defaultValue={saturdayInputs.input12}
							...
							<div className='parentGrid'>
								<div className=''>
									<div className='grid'>
										<input
											type='time'
											defaultValue={saturdayInputs.input15}
											onFocus={() => handleInputFocus(14)}
											onChange={e => handleInputChange('input15', e)}
										/>
										<input
											type='time'
											defaultValue={saturdayInputs.input16}
									...
									<div className='grid'>
										<input
											type='time'
											defaultValue={saturdayInputs.input17}
											onFocus={() => handleInputFocus(16)}
											onChange={e => handleInputChange('input17', e)}
										/>
										<input
											type='time'
											defaultValue={saturdayInputs.input18}
								...
								<div className='parentGrid'>
									<div className='grid'>
										<input
											type='time'
											defaultValue={saturdayInputs.input19}
											onFocus={() => handleInputFocus(18)}
											onChange={e => handleInputChange('input19', e)}
										/>
										<input
											type='time'
											defaultValue={saturdayInputs.input20}
									...
									<div className='grid'>
										<input
											type='time'
											defaultValue={saturdayInputs.input21}
											onFocus={() => handleInputFocus(20)}
											onChange={e => handleInputChange('input21', e)}
										/>
										<input
											type='time'
											defaultValue={saturdayInputs.input22}
									...
									<div className='grid'>
										<input
											type='time'
											defaultValue={saturdayInputs.input23}
											onFocus={() => handleInputFocus(22)}
											onChange={e => handleInputChange('input23', e)}
										/>
										<input
											type='time'
											defaultValue={saturdayInputs.input24}
									...
									<div className='grid'>
										<input
											type='time'
											defaultValue={saturdayInputs.input25}
											onFocus={() => handleInputFocus(24)}
											onChange={e => handleInputChange('input25', e)}
										/>
										<input
											type='time'
											defaultValue={saturdayInputs.input26}
					...
					<input
						...
						type='checkbox'
						checked={disableAudioDays.saturday}
						onChange={() => {
							handleCheckboxChange('saturday')
							setDisableAudioDays(prevDays => ({
								...prevDays,
								saturday: !prevDays.saturday,
							}))
						}}
					/>
					<label
